...
public:
  ...
  void retrieve(int32_t *nodeIds, int64_t num_nodes, int *node_index, cudaStream_t stream, 
      ull *misses = nullptr, ull *lookups = nullptr, ull *inserts = nullptr);
  void transfer(int32_t *nodeIds, int64_t num_nodes, float *output_buffer, int32_t* cache_index,
