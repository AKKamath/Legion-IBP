...
trainset.tofile('./pubmed/'+'trainingset')
validset = valid_idx.astype(np.int32)
validset.tofile('./pubmed/'+'validationset')
testset = test_idx.astype(np.int32)
testset.tofile('./pubmed/'+'testingset')
labels = label.astype(np.int32)
labels.tofile('./pubmed/'+'labels')
features = feature.astype(np.float32)
features.tofile('./pubmed/'+'features')
...
edge_src.tofile('./pubmed/'+'edge_src')
edge_dst = (csr.indices).astype(np.int32)
edge_dst.tofile('./pubmed/'+'edge_dst')
