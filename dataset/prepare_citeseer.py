...
trainset.tofile('./citeseer/'+'trainingset')
validset = valid_idx.astype(np.int32)
validset.tofile('./citeseer/'+'validationset')
testset = test_idx.astype(np.int32)
testset.tofile('./citeseer/'+'testingset')
labels = label.astype(np.int32)
labels.tofile('./citeseer/'+'labels')
features = feature.astype(np.float32)
features.tofile('./citeseer/'+'features')
...
edge_src.tofile('./citeseer/'+'edge_src')
edge_dst = (csr.indices).astype(np.int32)
edge_dst.tofile('./citeseer/'+'edge_dst')
